...
public class FarmaciasBenavidesCrawler implements FarmaciaCrawler {
    ...
    public List<Producto> buscarProductos(String nombre) {
        ...
        try {
            ...
            PageBusquedaFarmaciasBenavides pagina = new PageBusquedaFarmaciasBenavides(driver);

            String terminoCodificado = URLEncoder.encode(nombre, StandardCharsets.UTF_8);
            String urlBusqueda = "https://www.benavides.com.mx/catalogsearch/result/?q=" + terminoCodificado;
