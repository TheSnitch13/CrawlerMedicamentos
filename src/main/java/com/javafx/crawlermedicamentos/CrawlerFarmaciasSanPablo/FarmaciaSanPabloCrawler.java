...
public class FarmaciaSanPabloCrawler implements FarmaciaCrawler {
    ...
    public List<Producto> buscarProductos(String nombre) {
        ...
        try {
            ...
            PageBusquedaFarmaciaSanPablo pagina = new PageBusquedaFarmaciaSanPablo(driver);

            String terminoCodificado = URLEncoder.encode(nombre, StandardCharsets.UTF_8);
            String urlBusqueda = "https://www.farmaciasanpablo.com.mx/search/" + terminoCodificado + "?pageSize=48&currentPage=0";
